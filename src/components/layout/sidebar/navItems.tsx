...
import { LayoutDashboard, PenTool, GraduationCap, LineChart, FileText, Users, Trophy, School, UserCircle, Settings, BookOpen, Home, ClipboardList, CalendarCheck, Heart, Bell, Briefcase, DollarSign, UserCheck, Building2 } from 'lucide-react';
...
export const navItems: NavItem[] = [
    ...
    { label: 'Academic Structure', href: '/dashboard/academic-structure', roles: adminRoles, icon: <School size={18} style={{ flexShrink: 0 }} /> },
    ...
    { label: 'Administration', href: '/dashboard/administration', roles: adminRoles, icon: <Settings size={18} style={{ flexShrink: 0 }} /> },
