      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between" style={{ gap: '32px', marginBottom: '24px' }}>
          <div className="flex items-center" style={{ gap: '12px' }}>
            <Image src="/images/logo.jpg" alt="Matokeo Logo" width={36} height={36} className="rounded-lg object-cover" />
            <div>
              <span style={{ fontFamily: 'var(--font-display)', fontWeight: 600, color: 'var(--color-text-primary)', fontSize: '1.125rem', letterSpacing: '-0.01em', display: 'block' }}>Matokeo</span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between" style={{ gap: '16px' }}>
          <span style={{ color: 'var(--color-text-muted)', fontFamily: 'var(--font-body)', fontSize: '0.75rem' }}>© {new Date().getFullYear()} Matokeo School Management System. All rights reserved.</span>
