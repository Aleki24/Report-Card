...
const s = StyleSheet.create({
    ...
    logo: { width: 70, height: 70, borderRadius: 35, objectFit: 'contain', backgroundColor: WHITE },
    logoPlaceholder: { width: 70, height: 70, borderRadius: 35, backgroundColor: LIGHT_GRAY, alignItems: 'center', justifyContent: 'center' },
